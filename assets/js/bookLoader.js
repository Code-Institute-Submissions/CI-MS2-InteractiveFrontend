...
$(document).ready(function () {
    ...
    $.getJSON("../assets/js/books.json", function (data, status) {
        ...
        $("#img-container").hide().html("<img src=" + data.sv.dittLivOchMittEn.coverIMG + " style='float: left; max-width: 180px; height: auto; margin-right: 10px;'>").fadeIn(400);
        $("#title").hide().html("<h1>" + data.sv.dittLivOchMittEn.title + "</h1>").fadeIn(400);
        $("#isbn").hide().html("<h5>ISBN: " + data.sv.dittLivOchMittEn.isbn + "<h5>").fadeIn(400);
        $("#published").hide().html("<h5>Year of publication: " + data.sv.dittLivOchMittEn.published + "</h5>").fadeIn(400);
        $("#quote").hide().html("<h5>Quote: " + data.sv.dittLivOchMittEn.quote + "</h5>").fadeIn(400);
        $("#goodreads").hide().html("<a href='" + data.sv.dittLivOchMittEn.goodReadsURL + "' target='_blank'><img src='../assets/images/icons/goodreads_icon_32x32.png'> Se boken på Goodreads.com").fadeIn(400);
    ...
    $("#btn-moderspassion-sv").click(function () {
        ...
        $("#published").hide().html("<h5>Year of publication: " + data.sv.moderspassion.published + "</h5>").fadeIn(400);
        $("#quote").hide().html("<h5>Quote: " + data.sv.moderspassion.quote + "</h5>").fadeIn(400);
    ...
    $("#btn-slumpvandring-sv").click(function () {
        ...
        $("#published").hide().html("<h5>Year of publication: " + data.sv.slumpvandring.published + "</h5>").fadeIn(400);
        $("#quote").hide().html("<h5>Quote: " + data.sv.slumpvandring.quote + "</h5>").fadeIn(400);
    ...
    $("#btn-miriam-sv").click(function () {
        ...
        $("#published").hide().html("<h5>Year of publication: " + data.sv.miriam.published + "</h5>").fadeIn(400);
        $("#quote").hide().html("<h5>Quote: " + data.sv.miriam.quote + "</h5>").fadeIn(400);
    ...
    $("#btn-isochvatten-sv").click(function () {
        ...
        $("#published").hide().html("<h5>Year of publication: " + data.sv.isOchVatten.published + "</h5>").fadeIn(400);
        $("#quote").hide().html("<h5>Quote: " + data.sv.isOchVatten.quote + "</h5>").fadeIn(400);
